...
class DashboardController extends Controller
{
    ...
    public function index()
    {
      ...
      $yearly_total_stock = self::yearl_total_stock($financial_year->id);
      ...
      $yearly_stock_seedling_wise_datas = self::yearly_stock_seedlink_wise(date("Y-m-d"),$limit = 5);

      $app_status_data = self::app_status();

      return response()->json(compact('financial_years','yearly_total_stock','yearly_stock_category_wise_datas','yearly_stock_seedling_wise_datas','app_status_data','yearly_stock_purpose_wise_datas'));
      
      //return view(self::VIEW_PATH . 'index', compact('financial_years','yearl_total_stock','yearly_stock_category_wise_datas','yearly_stock_seedlink_wise_datas','app_status_data'));
    }

    public function yearly_total_stock($id){
      $yearly_total_stock = self::yearl_total_stock($id);
      return response()->json($yearly_total_stock);
    }
    ...
    public function view(){
      ...
      $yearly_stock_seedling_wise_datas = self::yearly_stock_seedlink_wise(date("Y-m-d"),$limit = 10000);
      return response()->json(compact('yearly_stock_seedling_wise_datas'));
    ...
    public function view_category($id){
      ...
      return response()->json(compact('id','yearly_stock_category_forestdivision_wise'));
      
    }
     
    public function view_category_range($id1, $id){

      $yearly_stock_category_range_wise = self::yearly_stock_category_range_wise(date("Y-m-d"),$limit = 10000, $id1, $id );
      return response()->json(compact('id1','id','yearly_stock_category_range_wise'));
    
    }
 
    public function view_category_bit($id1, $id){

      $yearly_stock_category_bit_wise = self::yearly_stock_category_bit_wise(date("Y-m-d"),$limit = 10000, $id1, $id );
      return response()->json(compact('yearly_stock_category_bit_wise'));
    ...
    public function view_seedling($id){

      $yearly_stock_seedling_forestdivision_wise = self::yearly_stock_seedling_forestdivision_wise(date("Y-m-d"),$limit = 10000, $id);
      return response()->json(compact('id','yearly_stock_seedling_forestdivision_wise'));
    
    }

    public function view_seedling_range($id1, $id){

      $yearly_stock_seedling_range_wise = self::yearly_stock_seedling_range_wise(date("Y-m-d"),$limit = 10000, $id1, $id );
      return response()->json(compact('id1','id','yearly_stock_seedling_range_wise'));
    
    }

    public function view_seedling_bit($id1, $id){

      $yearly_stock_seedling_bit_wise = self::yearly_stock_seedling_bit_wise(date("Y-m-d"),$limit = 10000, $id1, $id );
      return response()->json(compact('yearly_stock_seedling_bit_wise'));
