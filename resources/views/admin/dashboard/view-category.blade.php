          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody>
                 @foreach ($yearly_stock_category_forestdivision_wise as $key => $item)
                  <tr>
                    <td>{{(app()->getLocale() == 'en') ? $key+1 : NumberToBanglaWord::engToBn($key+1)}}</td>
                    <td><a href="{{route('admin.dashboard.view-category-range',[$id,$item['id'] ] )}}">{{$item['title_'. app()->getLocale()]}}</a></td>
