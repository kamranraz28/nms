              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>{{(app()->getLocale() == 'en') ? $district->bbs_code : NumberToBanglaWord::engToBn($district->bbs_code)}}</td>
                    {{-- <td>{{@$district->state->{'title_'. app()->getLocale()} }}</td> --}}
                    <td>{{$district->division->{'title_'. app()->getLocale()} }}</td>
                    <td>{{(app()->getLocale() == 'en') ? date('d-m-Y', strtotime($district->created_at)) : EnglishToBanglaDate::dateFormatEnglishToBangla(date('d-m-Y', strtotime($district->created_at)))}}</td>
                    <td>
