...
@section('title')
  ...
  @if (count($parameters)>0)
    {{-- {{__('admin.report_five.from_date')}} : {{(app()->getLocale() == 'en') ? date('d-m-Y', strtotime($parameters['from_date'])) : EnglishToBanglaDate::dateFormatEnglishToBangla(date('d-m-Y', strtotime($parameters['from_date'])))}} || {{__('admin.report_five.to_date')}} : {{(app()->getLocale() == 'en') ? date('d-m-Y', strtotime($parameters['to_date'])) : EnglishToBanglaDate::dateFormatEnglishToBangla(date('d-m-Y', strtotime($parameters['to_date'])))}} --}}
    {{ @$parameters['forest_division_'. app()->getLocale()] }} 
    {!! __('admin.report_five.view') !!}, 
    {{(app()->getLocale() == 'en') ? $parameters['budget_year_view'] : EnglishToBanglaDate::dateFormatEnglishToBangla($parameters['budget_year_view'])}} 
...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <h1 class="text-info">
              <i class="fas fa-bookmark"></i> {{ __('admin.report_five.view') }}
            </h1>
          </div>
    ...
    <section class="content-header">
      <div class="container-fluid">
        @can('create', app('App\Models\ReportFive'))
          <form class="form-edit-add" sale="form" id="sale_entry_form"
            action="{{route('admin.report_five.store')}}"
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="stock_type_id">{{ __('admin.report_five.stock_type') }} </label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="budget_id">{{ __('admin.report_five.budget') }}</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="financial_year_id">{{ __('admin.report_five.financial_year') }}<span style="color: red"> * </span></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_division_id">{{ __('admin.report_five.forest_division') }}<span style="color: red"> * </span></label>
                  <select onfocusout="check()" class="form-control select2" name="forest_division_id" id="forest_division_id" required>
                    <option value="">{{ __('admin.common.select') }}</option>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_range_id">{{ __('admin.report_five.forest_range') }} <!--<span style="color: red"> * </span>--></label>
            ...
            <div class="row">
              <div class="col-md-12">
                <hr>
                <br>
                @can('print', app('App\Models\ReportFive'))
                  @if (count($report_fives)>0)
                    <div class="col-12">
                ...
                @can('print', app('App\Models\ReportFive'))
                  @if (count($report_fives)>0)
                  <div class="col-12">
                    <a target="_blank" style="float: right" href="{{route('admin.report_five.download')}}" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-download"></i> 
                ...
                <div class="row">
                  <div class="col-12 table-responsive">
                    <table class="table table-striped" id="example1">
                      ...
                      <tr>
                        <th>{{__('admin.report_five.district')}}</th>
                        <th>{{__('admin.report_five.forest_range')}}</th>
                        <th>
                          ...
                          {!! __('admin.report_five.pre_stock') !!}
                        </th>
                        <th>
                          {{(app()->getLocale() == 'en') ? $parameters['budget_year_view'] : EnglishToBanglaDate::dateFormatEnglishToBangla($parameters['budget_year_view'])}} <br>
                          {!! __('admin.report_five.current_total_stock_in') !!}
                        </th>
                        <th>
                          {{(app()->getLocale() == 'en') ? $parameters['till_date_view'] : EnglishToBanglaDate::dateFormatEnglishToBangla($parameters['till_date_view'])}} <br>
                          {!! __('admin.report_five.current_total_stock_out') !!}
                        </th>
                        <th>
                          {{(app()->getLocale() == 'en') ? $parameters['to_date_view'] : EnglishToBanglaDate::dateFormatEnglishToBangla($parameters['to_date_view'])}} <br>
                          {!! __('admin.report_five.current_total_stock') !!}
                        </th>
                      </tr>
                      </thead>
                      <tbody>
                      @php
                          usort($report_fives, function($a, $b) {
                          return strcmp($a['district_'. app()->getLocale()], $b['district_'. app()->getLocale()]);
                          });
                        @endphp
                      @foreach ($report_fives as $key => $item)
                      <tr>
                      ...
                      @foreach ($forest_district_data as $key => $item)
                        <tr style="font-weight: 600!important;">
                          {{-- <td></td> --}}
                          <td> {!! __('admin.report_five.total_stock_division_wise') !!} </td>
