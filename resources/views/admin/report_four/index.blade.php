...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <h1 class="text-info">
              <i class="fas fa-bookmark"></i> {{ __('admin.report_four.view') }}
            </h1>
          </div>
    ...
    <section class="content-header">
      <div class="container-fluid">
        @can('create', app('App\Models\ReportFour'))
          <form class="form-edit-add" sale="form" id="sale_entry_form"
            action="{{route('admin.report_four.store')}}"
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="stock_type_id">{{ __('admin.report_four.stock_type') }} </label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="budget_id">{{ __('admin.report_four.budget') }}</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="financial_year_id">{{ __('admin.report_four.financial_year') }}<span style="color: red"> * </span></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_division_id">{{ __('admin.report_four.forest_division') }}<span style="color: red"> * </span></label>
              ...
              <div class="col-md-4" style="display:none">
                <div class="form-group">
                  <label for="forest_beat_id">{{ __('admin.report_four.forest_beat') }} <!--<span style="color: red"> * </span>--></label>
            ...
            <div class="row">
              <div class="col-md-12">
                <hr>
                <br>
                @can('print', app('App\Models\ReportFour'))
                  @if (count($report_fours)>0)
                    <div class="col-12">
                  ...
                  <div class="col-12 table-responsive">
                    <table class="table table-striped" id="example1">
                      ...
                      <tr>
                        ...
                        <th>{{__('admin.report_four.forest_range')}}</th>
                        <th>{{__('admin.report_four.forest_beat')}}</th>
                        <th>
                          ...
                          {!! __('admin.report_four.pre_stock') !!}
                        </th>
                        <th>
                      ...
                      @if ($authUser->userType->default_role != Admin::DEFAULT_ROLE_LIST[6])
                        @foreach ($forest_district_data as $key => $item)
                          <tr style="font-weight: 600!important;">
                            {{-- <td></td> --}}
                            <td> {!! __('admin.report_four.total_stock_range_wise') !!} </td>
                            <td>{{ $item['forest_range_'. app()->getLocale()] }}</td>
