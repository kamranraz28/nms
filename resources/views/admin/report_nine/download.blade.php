...
<body>
                        ...
                        <div class="col-12">
                            ...
                            <div>
                                ...
                                <thead>
                                    ...
                                    <th style="text-align: center;font-weight: bolder" colspan="{{count($categories) + 1}}">{{(app()->getLocale() == 'en') ? __('admin.report_nine.closing_stock') . @$parameters['to_date_view'] : EnglishToBanglaDate::dateFormatEnglishToBangla(@$parameters['to_date_views']) . __('admin.report_nine.closing_stock')  }}</th>
                                    </tr>
    ...
    @php
        Session::forget(['dreport_nines','dparameters','dfooter_report_nines']);
    @endphp
</body>
</html>