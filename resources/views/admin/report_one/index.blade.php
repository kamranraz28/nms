...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <h1 class="text-info">
              <i class="fas fa-bookmark"></i> {{ __('admin.report_one.view') }}
            </h1>
          </div>
    ...
    <section class="content-header">
      <div class="container-fluid">
        @can('create', app('App\Models\ReportOne'))
          <form class="form-edit-add" sale="form" id="sale_entry_form"
            action="{{route('admin.report_one.store')}}"
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_state_id">{{ __('admin.report_one.forest_state') }}</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_division_id">{{ __('admin.report_one.forest_division') }}</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_range_id">{{ __('admin.report_one.forest_range') }} <!--<span style="color: red"> * </span>--></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_beat_id">{{ __('admin.report_one.forest_beat') }} <!--<span style="color: red"> * </span>--></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="from_date">{{ __('admin.report_one.from_date') }}</label>
                  <input type="text" name="from_date"
                  id="from_date" placeholder="{{ __('admin.report_one.from_date') }}" 
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  id="to_date" placeholder="{{ __('admin.report_one.to_date') }}" 
