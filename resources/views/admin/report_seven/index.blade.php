...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <h1 class="text-info">
              <i class="fas fa-bookmark"></i> {{ __('admin.report_seven.view') }}
            </h1>
          </div>
    ...
    <section class="content-header">
      <div class="container-fluid">
        @can('create', app('App\Models\ReportSeven'))
          <form class="form-edit-add" sale="form" id="sale_entry_form"
            action="{{route('admin.report_seven.store')}}"
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="stock_type_id">{{ __('admin.report_seven.stock_type') }} </label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="budget_id">{{ __('admin.report_seven.budget') }}</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="financial_year_id">{{ __('admin.report_seven.financial_year') }}<span style="color: red"> * </span></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_division_id">{{ __('admin.report_seven.forest_division') }}<span style="color: red"> * </span></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_beat_id">{{ __('admin.report_seven.forest_beat') }} <!--<span style="color: red"> * </span>--></label>
                ...
                <div class="row">
                  <div class="col-12 table-responsive">
                    <table class="table table-striped" id="example1">
                      ...
                      <tr>
                        <th colspan="7"> 
                          <p style="text-align: center;">
                            {{ @$parameters['forest_division_'. app()->getLocale()] }} 
                            <br> 
                            {!! __('admin.report_seven.title') !!}<br>
                            {{(app()->getLocale() == 'en') ? $parameters['budget_year_view'] : EnglishToBanglaDate::dateFormatEnglishToBangla($parameters['budget_year_view'])}} 
                          </p> 
                        </th>
                      </tr>
                      ...
                      <tr>
                        <th>{{__('admin.report_seven.district')}}</th>
                        <th>{{__('admin.report_seven.upazila')}}</th>
                        <th>{{__('admin.report_seven.forest_beat')}}</th>
                        <th>
                          ...
                          {!! __('admin.report_seven.pre_stock') !!}
                        </th>
                        <th>
                      ...
                      @if ($authUser->userType->default_role != Admin::DEFAULT_ROLE_LIST[6])
                        @foreach ($forest_district_data as $key => $item)
                          <tr style="font-weight: 600!important;">
                            <td></td>
                            <td> {!! __('admin.report_seven.total_stock_division_wise') !!} </td>
