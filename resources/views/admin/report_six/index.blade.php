...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <h1 class="text-info">
              <i class="fas fa-bookmark"></i> {{ __('admin.report_six.view') }}
            </h1>
          </div>
    ...
    <section class="content-header">
      <div class="container-fluid">
        @can('create', app('App\Models\ReportSix'))
          <form class="form-edit-add" sale="form" id="sale_entry_form"
            action="{{route('admin.report_six.store')}}"
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="stock_type_id">{{ __('admin.report_six.stock_type') }} </label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="budget_id">{{ __('admin.report_six.budget') }}</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="f_date">{{ __('admin.report_six.f_date') }}<span style="color: red"> * </span></label>
                  <input type="" name="f_date"
                  id="f_date" placeholder="{{ __('admin.report_six.f_date') }}" 
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_division_id">{{ __('admin.report_six.forest_division') }}<span style="color: red"> * </span></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="forest_range_id">{{ __('admin.report_six.forest_range') }} <!--<span style="color: red"> * </span>--></label>
                ...
                <div class="row">
                  <div class="col-12 table-responsive">
                    <table class="table table-striped" id="example1">
                      ...
                      <tr>
                        <th>{{__('admin.report_six.district')}}</th>
                        <th>{{__('admin.report_six.forest_range')}}</th>
                        <th>
                      ...
                      @foreach ($forest_district_data as $key => $item)
                        <tr style="font-weight: 600!important;">
                          {{-- <td></td> --}}
                          <td> {!! __('admin.report_six.total_stock_division_wise') !!} </td>
