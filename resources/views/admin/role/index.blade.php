              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>{{(app()->getLocale() == 'en') ? $role->code : NumberToBanglaWord::engToBn($role->code)}}</td>
                    <td>{{(app()->getLocale() == 'en') ? date('d-m-Y', strtotime($role->created_at)) : EnglishToBanglaDate::dateFormatEnglishToBangla(date('d-m-Y', strtotime($role->created_at)))}}</td>
                    <td>
