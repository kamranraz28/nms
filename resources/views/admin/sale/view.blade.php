          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-6">
                  {{-- <p class="lead" style="float: right; mirgin-right-21%"><b>{{__('admin.sale.free')}} : </b> <strong>{{(app()->getLocale() == 'en') ? App\Models\Status::EN1[$sale->free] : App\Models\Status::BN1[$sale->free]}}</strong></p> --}}
