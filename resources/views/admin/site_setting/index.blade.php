              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    {{-- <td>{{(app()->getLocale() == 'en') ? $site_setting->site_mobile : NumberToBanglaWord::engToBn($site_setting->site_mobile)}}</td> --}}
                    <td>{{(app()->getLocale() == 'en') ? $site_setting->site_mobile : NumberToBanglaWord::engToBn($site_setting->site_mobile)}}</td>
                    <td>{{$site_setting->site_email}}</td>
                    <td>{{$site_setting->site_web}}</td>
                    <!-- <td>{{(app()->getLocale() == 'en') ? $site_setting->vat : NumberToBanglaWord::engToBn($site_setting->vat)}}</td> -->
